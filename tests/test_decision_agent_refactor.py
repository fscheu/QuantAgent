...
class TestDecisionAgentOutput:
    ...
    def test_output_is_pydantic_model(
        self,
        mock_llm,
        sample_indicator_report,
        sample_pattern_report,
        sample_trend_report,
    ):
...
class TestDecisionValues:
    ...
    def test_decision_is_valid_choice(
        self,
        mock_llm,
        sample_indicator_report,
        sample_pattern_report,
...
class TestErrorHandling:
    ...
    def test_malformed_json_creates_hold_decision(
        self,
        mock_llm,
        sample_indicator_report,
        sample_pattern_report,
...
class TestStateConsumption:
    ...
    def test_consumes_structured_reports(
        self,
        mock_llm,
        sample_indicator_report,
        sample_pattern_report,
