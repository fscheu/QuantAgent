...
- [QuantAgent-um8-PL-backtest-batch-processing.md](./QuantAgent-um8-PL-backtest-batch-processing.md) - Batch processing para llamadas de backtesting (cost/throughput)
