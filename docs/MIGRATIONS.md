...
### Order
Represents a trading order with the following fields:
- **id**: Primary key
...
### Signal
Represents trading signals generated by the analysis agents:
- **id**: Primary key
- **symbol**: Trading symbol
- **signal**: LONG, SHORT, NEUTRAL, or CLOSE
- **confidence**: Signal confidence (0-1 scale)
- **timeframe**: Candlestick timeframe (1m, 5m, 1h, 4h, 1d, etc.)
- **Technical Indicators:**
  - rsi: Relative Strength Index value
  - macd: MACD value
  - stochastic: Stochastic oscillator value
  - roc: Rate of Change
  - williams_r: Williams %R value
- **pattern**: Identified candlestick pattern
- **trend**: Identified trend (Uptrend, Downtrend, Sideways)
...
- **entry_signal**: Signal that triggered entry
- **exit_signal**: Signal that triggered exit
- **timeframe**: Trading timeframe
- **opened_at**: Trade opening timestamp
- **closed_at**: Trade closing timestamp (null if open)
- **notes**: Trade notes

**Relationships:**
- Many Trades belong to one Order
