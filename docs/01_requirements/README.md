...
- [QuantAgent-4fm-RQ-externalize-trading-config.md](./QuantAgent-4fm-RQ-externalize-trading-config.md) - Externalize hardcoded trading configuration to env or database
