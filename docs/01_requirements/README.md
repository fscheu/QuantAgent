...
- [QuantAgent-6t4-RQ-structured-output-agents.md](./QuantAgent-6t4-RQ-structured-output-agents.md) - Use `with_structured_output` in pattern/trend agents (P3, refactor)
