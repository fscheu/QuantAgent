You are running a Hermes autodev phase under a strict executor contract.
        ...
        - Artifacts dir: /home/azureuser/repos/projects/QuantAgent/docs/envelopes/QuantAgent-82t/20260504T174542Z-QuantAgent-82t-implementer
...
worktree_path: "/tmp/autodev-worktrees/QuantAgent/QuantAgent-82t/implementer-20260504T174542Z"
skill: "autodev-implementer"
mode: "write"
capabilities:
  read_repo: true
...
budget:
  ...
  max_minutes: 45
  max_cost_usd: null
artifacts_dir: "/home/azureuser/repos/projects/QuantAgent/docs/envelopes/QuantAgent-82t/20260504T174542Z-QuantAgent-82t-implementer"
generated_at: "2026-05-04T17:45:42.351088+00:00"
preflight:
  repo_dirty: true
  dirty_files:
...
# Autodev Input Envelope — QuantAgent-82t — implementer

## Objective

Execute the `implementer` phase for Beads issue `QuantAgent-82t`: Re-enable unit tests in CI pipeline (main-ci-deploy.yml).
...
- Artifact issue snapshot: `/home/azureuser/repos/projects/QuantAgent/docs/envelopes/QuantAgent-82t/20260504T174542Z-QuantAgent-82t-implementer/issue.json`.
