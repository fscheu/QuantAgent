...
- [QuantAgent-6t4-AC-structured-output-agents.md](./QuantAgent-6t4-AC-structured-output-agents.md) - Use `with_structured_output` in pattern/trend agents (P3, refactor)
