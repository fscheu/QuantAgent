...
- [QuantAgent-4fm-AC-externalize-trading-config.md](./QuantAgent-4fm-AC-externalize-trading-config.md) - Externalize hardcoded trading configuration to env or database
