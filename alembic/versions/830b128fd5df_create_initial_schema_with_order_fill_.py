...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "average_fill_price", sa.Numeric(precision=18, scale=8), nullable=True
        ),
    ...
    op.create_index(
        "idx_symbol_created_at", "orders", ["symbol", "created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column("quantity", sa.Numeric(precision=18, scale=8), nullable=False),
        sa.Column(
            "average_entry_price", sa.Numeric(precision=18, scale=8), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_positions_opened_at"), "positions", ["opened_at"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "signal",
            sa.Enum("LONG", "SHORT", "NEUTRAL", "CLOSE", name="tradesignal"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_symbol_generated_at", "signals", ["symbol", "generated_at"], unique=False
    )
    op.create_index("idx_symbol_signal", "signals", ["symbol", "signal"], unique=False)
    op.create_index(
        op.f("ix_signals_generated_at"), "signals", ["generated_at"], unique=False
    )
    ...
    op.create_index(
        "idx_order_filled_at", "fills", ["order_id", "filled_at"], unique=False
    )
    ...
    op.create_index(
        "idx_symbol_closed_at", "trades", ["symbol", "closed_at"], unique=False
    )
    op.create_index(
        "idx_symbol_opened_at", "trades", ["symbol", "opened_at"], unique=False
    )
